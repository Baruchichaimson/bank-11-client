...
export default function Login() {
  ...
  /* ===== Handle verified redirect ===== */
  useEffect(() => {
    const verified = searchParams.get('verified');

    if (verified === '1') {
      setSuccess('Your account has been verified successfully. You can sign in.');
      setError('');
    }

    if (verified === '0') {
      setError('Account verification failed or the link has expired.');
      setSuccess('');
    }
  }, [searchParams]);
